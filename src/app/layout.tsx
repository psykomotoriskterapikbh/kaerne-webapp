...
export const metadata: Metadata = {
  ...
  description: "Astrid hjælper socialrådgivere, sagsbehandlere og indkøbere med sagssparring, Barnets Lov og Serviceloven, notater, frister og valg af den rette indsats og aktør. Gratis at prøve. Støtte — ikke skøn.",
  openGraph: {
