...
export const SLASH_COMMANDS: SlashCmd[] = [
  ...
  { cmd: "/resume", desc: "Resumé + tidslinje af sag", prompt: "Lav et kort, kronologisk resumé og en tidslinje over de vigtigste hændelser, diagnoser og indsatser ud fra denne (anonymiserede) tekst:\n\n" },
